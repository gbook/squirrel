...
public:
    ...
    bool DoModify(QString packagePath, QString operation, ObjectType object, QString dataPath, QString objectData, QString objectID, QString subjectID, int studyNum, int seriesNum, int digits, int startNum, QString prefix, bool randomize, QString &m);
    ...
    bool RenumberSubjects(QString packagePath, int digits, int startNum, QString prefix, bool randomize, QString &m);
